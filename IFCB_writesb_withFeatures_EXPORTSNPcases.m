...
hdr.documents = 'IFCB_brief_protocol_Sosik_Oct2021.docx;checklist_IFCB_plankton_and_particles_EXPORTS-EXPORTSNP_Sosik.docx';
...
hdr.associated_files = [hdr.experiment '-' hdr.cruise '_' cruise '_IFCB_raw_data.tgz'];
hdr.associated_file_types = 'raw';
...
hdr.missing = '-9999';
hdr.delimiter = 'comma'; 
hdr.fields = 'associatedMedia,biovolume,area_cross_section,length_representation,width_representation,equivalent_spherical_diameter';
hdr.units = 'none,um^3,um^2,um,um,um';
